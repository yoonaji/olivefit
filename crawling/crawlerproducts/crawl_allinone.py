...
def crawl_skin_list_html(playwright_page, page):
    url = f"https://www.oliveyoung.co.kr/store/display/getMCategoryList.do?dispCatNo=1000001000700070006&prdSort=01&pageIdx=1&rowsPerPage=24"
...
def write_data_to_db(data):
    ...
    for row in data:
        cur.execute("""
            INSERT INTO allinone_products (product_brand, product_name, product_link)
            VALUES (%s, %s, %s)
