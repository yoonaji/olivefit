...
def crawl_skin_list_html(playwright_page, page):
    url = f"https://www.oliveyoung.co.kr/store/display/getMCategoryList.do?dispCatNo=100000100010016&pageIdx={page}&rowsPerPage=24"
...
def write_data_to_db(data):
    ...
    for row in data:
        cur.execute("""
            INSERT INTO lotion_products (product_brand, product_name, product_link)
            VALUES (%s, %s, %s)
